...
php occ user_oidc:provider authentik --clientid="$OIDC_CLIENT_ID" --clientsecret="$OIDC_CLIENT_SECRET" --discoveryuri="https://authentik.slc1.jakerob.pro/application/o/nextcloud/.well-known/openid-configuration" --mapping-uid="sub" --mapping-quota="quota" --mapping-groups="groups" --unique-uid="0"
